...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './email-category-view-model.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILCATEGORYVIEWMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILCATEGORYVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILCATEGORYVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILCATEGORYVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILCATEGORYVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILCATEGORYVIEWMODEL actions', async () => {
      const expectedActions = [
        {
