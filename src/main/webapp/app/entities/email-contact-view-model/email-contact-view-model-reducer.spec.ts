...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './email-contact-view-model.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILCONTACTVIEWMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILCONTACTVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EMAILCONTACTVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EMAILCONTACTVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EMAILCONTACTVIEWMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EMAILCONTACTVIEWMODEL actions', async () => {
      const expectedActions = [
        {
