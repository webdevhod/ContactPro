...
import reducer, { getEntities, getEntity, reset } from './email-data.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EMAILDATA_LIST actions', async () => {
    ...
    it('dispatches FETCH_EMAILDATA actions', async () => {
      const expectedActions = [
        {
