      ...
      : Qt(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              'rtl' === Et(s || i).direction && (a += xt(i.clientWidth, s ? s.clientWidth : 0) - o), { width: o, height: r, x: a, y: l }
            );
          })(Tt(t))
        );
  }
        ...
        for (
          var s = i.mainAxis,
            ...
            v = [g].concat(b).reduce(function (t, i) {
              return t.concat(
                'auto' === _t(i)
                  ? te(e, { placement: i, boundary: h, rootBoundary: d, padding: c, flipVariations: p, allowedAutoPlacements: m })
                  : i
              );
            }, []),
            y = e.rects.reference,
